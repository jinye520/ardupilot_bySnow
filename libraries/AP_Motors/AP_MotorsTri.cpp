...
void AP_MotorsTri::output_to_motors()
{
    switch (_spool_state) {
        case SpoolState::SHUT_DOWN:
            ...
            rc_write(AP_MOTORS_MOT_1, output_to_pwm(0,0));
            rc_write(AP_MOTORS_MOT_2, output_to_pwm(0,0));
            rc_write(AP_MOTORS_MOT_4, output_to_pwm(0,0));
        ...
        case SpoolState::GROUND_IDLE:
            ...
            rc_write(AP_MOTORS_MOT_1, output_to_pwm(_actuator[1],1));
            rc_write(AP_MOTORS_MOT_2, output_to_pwm(_actuator[2],2));
            rc_write(AP_MOTORS_MOT_4, output_to_pwm(_actuator[4],4));
            rc_write_angle(AP_MOTORS_CH_TRI_YAW, 0);
            break;
